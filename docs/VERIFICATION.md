...
- [x] Workspace fits the viewport on wide screens: left product panel (hero image, thumbnail toggles, collapsible Generate / Storefront badge / Sales channels / Product details) and a Description panel plus History panel that scroll inside; one result notice at the top of the page that fades after success
